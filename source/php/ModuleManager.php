...
class ModuleManager
{
     ...
     */
    public function registerModule($slug, $nameSingular, $namePlural, $description, $supports = array(), $icon = null, $plugin = null, $cache_ttl = 0, $hideTitle = false, $moduleClass)
    {
        $labels = array(
        ...
        add_action('wp_enqueue_scripts', array($moduleClass, 'style'));
        add_action('wp_enqueue_scripts', array($moduleClass, 'script'));
     ...
     * @return void
     */
    public function initBundledModules()
    {
