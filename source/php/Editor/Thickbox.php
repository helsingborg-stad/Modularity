...
class Thickbox
{
    ...
    public function enqueue()
    {
        ...
        wp_register_script(
            'modularity-thickbox', 
            MODULARITY_URL . '/dist/js/modularity-editor-modal.' . \Modularity\App::$assetSuffix . '.js', 
            false, 
            '1.0.0', true
        );
        ...
        wp_register_style(
            'modularity-thickbox',
            MODULARITY_URL . '/dist/css/modularity-editor-modal.' . \Modularity\App::$assetSuffix . '.css',
            false,
            '1.0.0'
        );
