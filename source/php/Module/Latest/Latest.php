...
class Latest extends \Modularity\Module
{
    ...
    {
        wp_register_script('mod-latest-taxonomy', MODULARITY_URL . '/dist/js/mod-latest-taxonomy.min.js', false, filemtime(MODULARITY_PATH . 'dist/js/mod-latest-taxonomy.min.js'), false);
