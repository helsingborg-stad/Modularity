...
<div class="slider-image slider-image-desktop {{ apply_filters('Modularity/slider/desktop_image_hidden', 'hidden-xs hidden-sm') }}" style="background-image:url({{ ($slide['image_use'] !== false) ? $slide['image_use'][0] : '' }})"></div>
@endif
