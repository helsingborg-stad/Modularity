...
<div class="u-level-top u-position--absolute u-align--middle u-padding__x--3" iframe-acceptance-wrapper style="top:20%;">
    ...
    <iframe url="{{$url}}" title="{!! $description ?? apply_filters('the_title', $post_title) !!}" frameborder="0" style="width: 100%;height:100%; filter:blur(20px);pointer-events:none;"></iframe>
</div> 
