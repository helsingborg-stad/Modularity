<?php 
    ...
    'fields' => array(
        0 => array(
            ...
            'filter_context' => '',
            'share_option' => 0,
            'default_value' => __('Hero title', 'modularity'),
            'placeholder' => '',
            'prepend' => '',
            'append' => '',
            'maxlength' => '',
        ...
        3 => array(
            ...
            'key' => 'field_614b3fda41a1b',
            'label' => __('Overlay type', 'modularity'),
            'name' => 'mod_hero_overlay_type',
            'type' => 'select',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
            ...
            'share_option' => 0,
            'choices' => array(
                'neutral' => __('Neutral', 'modularity'),
                'vibrant' => __('Vibrant', 'modularity'),
            ),
            'default_value' => __('vibrant', 'modularity'),
            'allow_null' => 1,
            'multiple' => 0,
            'ui' => 0,
            'return_format' => 'value',
        ...
        4 => array(
            ...
            'repeater_post_id' => 0,
            'repeater_display_value' => 0,
            'key' => 'field_614b4098d06b1',
            'label' => __('Font color', 'modularity'),
            'name' => 'mod_hero_font_color',
            'type' => 'select',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
            ...
            'share_option' => 0,
            'choices' => array(
                'light' => __('Light', 'modularity'),
                'dark' => __('Dark', 'modularity'),
            ),
            'default_value' => __('light', 'modularity'),
            'allow_null' => 0,
            'multiple' => 0,
            'ui' => 0,
            'return_format' => 'value',
