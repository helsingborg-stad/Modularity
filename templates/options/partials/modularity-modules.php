...
<?php if (count(\Modularity\Module::$deprecated) > 0) : ?>
<p>
    ...
    <table class="modularity-table">
        ...
        <?php foreach ($available as $id => $module) : ?>
            <tr>
                ...
                <td><strong><?php echo $module['labels']['name']; ?></strong> <?php if (in_array($id, \Modularity\Module::$deprecated)) : ?><span class="modularity-deprecated" style="color:#ff0000;">(<?php _e('Deprecated', 'modularity'); ?>)</span><?php endif; ?></td>
