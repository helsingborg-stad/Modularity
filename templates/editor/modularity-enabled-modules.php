<div class="modularity-modules">
    ...
    <div class="modularity-module modularity-js-draggable" data-module-id="<?php echo $moduleId; ?>" data-sidebar-compability='<?php echo is_array($module['sidebar_compability']) ? json_encode($module['sidebar_compability']) : ''; ?>'>
